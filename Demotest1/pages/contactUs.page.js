...
export class ContactUsPage {
   ...
   */
  async goto() {
    // Use absolute path relative to the domain.
   ...
   * All fields are optional; only provided ones are filled.
   * @param {{
   *  firstName?: string;
   *  lastName?: string;
   *  email?: string;
  ...
  /**
   * Assert that the generic "Thank you" text appears after successful submit.
   */
